...
internal class PageConfiguration : IEntityTypeConfiguration<Domain.Page>
{
	public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<Domain.Page> builder)
	{
		...
		builder.Property(current => current.Author)
