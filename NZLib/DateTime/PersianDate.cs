...
public class PersianDate
{
	...
	{
		var persianDate = new PersianDate(dateTime: dateTime);
		var result = persianDate.ToString();
	...
	{
		DateTime = dateTime;
		Day = PersianCalendar.GetDayOfMonth(time: dateTime);
		Month = PersianCalendar.GetMonth(time: dateTime);
		Year = PersianCalendar.GetYear(time: dateTime);
	}
